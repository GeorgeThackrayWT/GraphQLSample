...
{
    public class CATLevelOfShrubRegenerationDTO : BaseDto, IRecord
    {
        ...
        public CATLevelOfShrubRegenerationDTO Clone()
        {
            return new CATLevelOfShrubRegenerationDTO()
            {
                Id = this.Id,
    ...
    public class CATLevelOfShrubRegenerationDTOEdit : PropertyBase<CATLevelOfShrubRegenerationDTOEdit>, IDuplicate
    {

        private CATLevelOfShrubRegenerationDTO _dto;


        public CATLevelOfShrubRegenerationDTOEdit()
        {
        ...
        public CATLevelOfShrubRegenerationDTO ConvertToDto()
        {
        ...
        {
            var t1 = (CATLevelOfShrubRegenerationDTOEdit)existingRecord;
        ...
        public void Make(CATLevelOfShrubRegenerationDTO test)
        {
        ...
        public static ExtRangeCollection<CATLevelOfShrubRegenerationDTOEdit> MakeCollection(List<CATLevelOfShrubRegenerationDTO> records)
        {

            var newData = new ExtRangeCollection<CATLevelOfShrubRegenerationDTOEdit>();

            foreach (var rec in records)
            {
                var e = new CATLevelOfShrubRegenerationDTOEdit();
                e.Make(rec);
                newData.AddItem(e);
            }
    ...
    public class CATLevelOfShrubRegenerationDTOEditList : ListObj<CATLevelOfShrubRegenerationDTO>, INotifyPropertyChanged, IRecord, IDuplicate
    {

        private CATLevelOfShrubRegenerationDTO _dto;


        public CATLevelOfShrubRegenerationDTOEditList()
        {
        ...
        public void MakeFromExisting(object existingRecord, int id)
        {
            var t1 = (CATLevelOfShrubRegenerationDTOEditList)existingRecord;
            var temp = t1.ConvertToDto();
            temp.Id = id;
            Make(temp);
        }//MakeFromExisting
        ...
        public static ExtRangeCollection<CATLevelOfShrubRegenerationDTOEditList> MakeCollection(List<CATLevelOfShrubRegenerationDTO> records)
        {

            var newData = new ExtRangeCollection<CATLevelOfShrubRegenerationDTOEditList>();

            foreach (var rec in records)
            {
                var e = new CATLevelOfShrubRegenerationDTOEditList();
                e.Make(rec);
                newData.AddItem(e);
            }
